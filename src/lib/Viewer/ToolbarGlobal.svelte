...
<div class="overlay-global d-flex align-items-center justify-content-end gap-4 px-2 py-1" class:background={toolbarBackground}>
    <div class="d-flex gap-1">
        {#if showWindowLevelButton}
            <button class="btn btn-icon" onclick={resetWindowLevel} aria-label="Reset W/L" title="Reset window/level">
        ...
        <button class="btn btn-icon" onclick={resetCamera} aria-label="Reset camera" title="Reset camera">
    ...
    {#if showScreenshotButton}
        <button class="btn btn-primary btn-icon" onclick={screenshot} aria-label="Save screenshot" title="Save screenshot">
